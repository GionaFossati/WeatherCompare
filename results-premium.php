    ...
    <main>
      ...
      <div class="column">
            ...
            <div class="temp media">
                ...
                <?php $media_today_max = explode(".", mediaponderata($p0_0[0],$p1_0,$p2_0[0]));
                echo '<div class="max">'.$media_today_max[0]."° <br></div>";

                $media_today_min = explode(".", mediaponderata($p00_0[0],$p11_0,$p22_0[0]));
            ...
            <div class="temp media">
                  ...
                  <?php  $media_tomorrow_max = explode(".", mediaponderata($p0_1[0],$p1_1,$p2_1[0]));
                      echo '<div class="max">'.$media_tomorrow_max[0]."° <br></div>";

                      $media_tomorrow_min = explode(".", mediaponderata($p00_1[0],$p11_1,$p22_1[0]));
            ...
            <div class="temp media">
                  <?php  $media_dayafter_max = explode(".", mediaponderata($p0_2[0],$p1_2,$p2_2[0]));
                        echo '<div class="max">'.$media_dayafter_max[0]."° <br></div>";

                        $media_dayafter_min = explode(".", mediaponderata($p00_2[0],$p11_2,$p22_2[0]));
